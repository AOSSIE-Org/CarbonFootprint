...
class CarbonFootprintCore extends CarbonFootprintCommon {
  ...
  computeTransitFootprint(data, type) {
    var footprint;
    if (type == 't') {
  ...
  createHTMLElement(footprint, distance) {
  ...
  createFootprintElement(distance) {
  ...
  createPTransitFootprintElement(data, type) {
  ...
  createTravelCostElement(distance) {
    var e = document.createElement('div');
