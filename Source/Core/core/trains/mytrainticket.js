var mytrainticketManager = function(footprintCore, settingsProvider) {
...
mytrainticketManager.prototype.setStyle = function(emission) {
...
mytrainticketManager.prototype.insertInDom = function(emission) {
...
mytrainticketManager.prototype.update = function() {
  if (
