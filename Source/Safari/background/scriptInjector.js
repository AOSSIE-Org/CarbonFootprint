...
injector.bingMaps = ["https://*.bing.com/maps*", "http://*.bing.com/maps*"];
...
injector.hereMaps = ["https://*.here.com/*", "http://*.here.com/*"];
...
injector.mapQuest = ["https://*.mapquest.com/*", "http://*.mapquest.com/*"];
...
injector.wazeMaps = ["http://www.waze.com/livemap*"];
...
injector.cleartrip = ["https://*.cleartrip.com/flights/*"];
...
injector.hipmunk = ["https://*.hipmunk.com/*"];
...
injector.makemytrip = ["https://*.makemytrip.com/air/*"];
...
injector.priceline = ["https://*.priceline.com/m/fly/*"];
...
injector.voyages = ["https://en.voyages-sncf.com/en/results*"];

injector.thalys = ["https://thalys.vsct.fr/billet-train/resultats*"];
injector.thalysInternational = [
  "https://travel.b-europe.com/thalys-be/*/booking/*",
...
injector.delta = ["https://*.delta.com/air-shopping/findFlights.action*"];

injector.aa = ["https://bookaa.amadeus.com/plnext/AADX*"];
...
injector.allFlights = injector.allFlights.concat(
  injector.cleartrip,
  injector.expedia,
  injector.googleFlights,
  injector.hipmunk,
...
for (injector.i in injector.allFlightURLs) {
  safari.extension.addContentScriptFromURL(
    injector.allFlightManagers[injector.i],
    injector.allFlightURLs[injector.i],
    [],
    true
  );
}
...
injector.commonScripts = [
  injector.URL + "core/CarbonFootprintCommon.js",
...
injector.commonScriptsMaps = injector.commonScripts.concat([
  injector.URL + "core/MapsCarbonFootprintCore.js",
...
injector.commonScriptsTrains = injector.commonScripts.concat([
  injector.URL + "core/TrainsCarbonFootprintCore.js",
...
for (injector.i in injector.commonScriptsFlights) {
  safari.extension.addContentScriptFromURL(
    injector.commonScriptsFlights[injector.i],
    injector.allFlights,
    [],
    true
  );
